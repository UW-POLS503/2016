...
- [Introduction to Statistical Learning](http://www-bcf.usc.edu/~gareth/ISL/). Ch 5.2-5.3,  Ch 7: "Moving Beyond Linearity" [pdf](http://www-bcf.usc.edu/~gareth/ISL/ISLR%20Fourth%20Printing.pdf)
...
- [Introduction to Statistical Learning](http://www-bcf.usc.edu/~gareth/ISL/). Ch 6.2: "Shrinkage Methods", Ch 5: "Resampling Methods" [pdf](http://www-bcf.usc.edu/~gareth/ISL/ISLR%20Fourth%20Printing.pdf)
- Wooldridge, Ch 17.1: "Logit and Probit Models for Binary Response"
...
- Shmeuli, Galit. 2010. "[To Explain or Predict?](http://projecteuclid.org/euclid.ss/1294167961)." *Statistical Science*. Get the big picture.
...
<!--  LocalWords:  GitHub Kitzez Github Peng Leeper blog apsa c13ay
 -->
<!--  LocalWords:  Editors' APSR AJPS html Wickham Rstudio Wooldridge
 -->
<!--  LocalWords:  Keele Sekhon Jasjeet Angrist Jörn toc '3' h2 16px
 -->
<!--  LocalWords:  h3 15px h4 14px Github Jörn
 -->
