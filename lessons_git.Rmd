...
In a terminal enter the following, but replace the the user name and email with your
GitHub username and your own email address.
To access a terminal from within RStudio from **Tools > Shell...**.

```console
git config --global user.name 'jrnold'
